...
This file is the legacy full-system reference. The DDD source of truth is split by Software Capability under
[`docs/capabilities`](capabilities/), where each capability owns its own `entity_model.md`.
